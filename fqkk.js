...
if ($.isNode()) {
  ...
  if (process.env.FQKK_URL && process.env.fqkkurl.indexOf('#') > -1) {
  fqkkurl = process.env.FQKK_URL.split('#');
  ...
  if (process.env.FQKK_HD && process.env.fqkkhd.indexOf('#') > -1) {
  fqkkhd = process.env.FQKK_HD.split('#');
  console.log(`您选择的是用"#"隔开\n`)
  }
